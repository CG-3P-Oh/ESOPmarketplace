jQuery( document ).ready( function($) {
	...
	function diplInitBarChart( $main ) {
		const $wrapper = $main.find( '.dipl_bar_chart_wrapper' );
	...
	$( '.dipl_bar_chart' ).each( function() {
		diplInitBarChart( $(this) );
	} );
} ); // over document ready.
