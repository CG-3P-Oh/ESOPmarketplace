...
class DIPL_BeforeAfterSlider extends ET_Builder_Module {
		...
		return array(
			...
			'borders'               => array(
				'default' => array(
					'css' => array(
						'main' => array(
							'border_styles' => '%%order_class%% .dipl-before-after-slider-wrapper',
							'border_radii'  => '%%order_class%% .dipl-before-after-slider-wrapper',
						),
					),
				),
			),
	...
	public function get_fields() {
		...
		return array(
			...
			'before_image_alt_text'            => array(
				'label'              => esc_html__( 'Before Image Alt Text', 'divi-plus' ),
				'type'               => 'text',
				'option_category'    => 'basic_option',
				...
				'toggle_slug'        => 'main_content',
				'sub_toggle'         => 'before_content',
				'description'        => esc_html__( 'Here you can input the before image alt text.', 'divi-plus' ),
			),
			...
			'show_before_label_on_hover'               => array(
				'label'           => esc_html__( 'Show Label Only On Hover', 'divi-plus' ),
				'type'            => 'yes_no_button',
				'option_category' => 'configuration',
				'options'         => array(
					'off' => esc_html__( 'No', 'divi-plus' ),
				...
				'toggle_slug'     => 'main_content',
				'sub_toggle'      => 'before_content',
				'description'     => esc_html__( 'Here you can choose whether to show before label only on hover or all the time.', 'divi-plus' ),
			),
			'before_label'                    => array(
				'label'           => esc_html__( 'Label', 'divi-plus' ),
				'type'            => 'text',
			...
			'after_image_alt_text'                             => array(
				'label'              => esc_html__( 'After Image Alt Text', 'divi-plus' ),
				'type'               => 'text',
				'option_category'    => 'basic_option',
				'dynamic_content' 	 => 'text',
				'tab_slug'           => 'general',
				'toggle_slug'        => 'main_content',
				'sub_toggle'         => 'after_content',
				'description'        => esc_html__( 'Here you can input the after image alt text.', 'divi-plus' ),
			),
			...
			'show_after_label_on_hover'               => array(
				'label'           => esc_html__( 'Show Label Only On Hover', 'divi-plus' ),
				'type'            => 'yes_no_button',
				'option_category' => 'configuration',
				'options'         => array(
				...
				'toggle_slug'     => 'main_content',
				'sub_toggle'      => 'after_content',
				'description'     => esc_html__( 'Here you can choose whether to show after label only on hover or all the time.', 'divi-plus' ),
			),
			'after_label'                     => array(
				'label'           => esc_html__( 'Label', 'divi-plus' ),
				'type'            => 'text',
	...
	public static function slider_images( $args = array() ) {
		...
		$before_image_alt_text = $args['before_image_alt_text'];
		$after_image_alt_text = $args['after_image_alt_text'];

		if ( '' !== $before_image ) {
			$before_image_wrapper = sprintf(
				'<img class="dipl-before-img" src="%1$s" alt="%2$s" />',
				$before_image,
				$before_image_alt_text
			);
		} else {
		...
		if ( '' !== $after_image ) {
			$after_image_wrapper = sprintf(
				'<img class="dipl-after-img" src="%1$s" alt="%2$s" />',
				$after_image,
				$after_image_alt_text
			);
		} else {
	...
	public function render( $attrs, $content, $render_slug ) {
		...
		$before_image_alt_text			 = esc_attr( $this->props['before_image_alt_text'] );
		...
		$after_image_alt_text			 = esc_attr( $this->props['after_image_alt_text'] );
		...
		$show_before_label_on_hover		 = $this->props['show_before_label_on_hover'];
		$show_after_label_on_hover		 = $this->props['show_after_label_on_hover'];
		...
		$before_image_wrapper = $multi_view->render_element(
			array(
				...
				'attrs'    => array(
					'src'   => '{{before_image}}',
					'class' => 'dipl-before-img no-lazyload skip-lazy',
					'alt'	=> $before_image_alt_text
				),
		...
		$after_image_wrapper = $multi_view->render_element(
			array(
				...
				'attrs'    => array(
					'src'   => '{{after_image}}',
					'class' => 'dipl-after-img no-lazyload skip-lazy',
					'alt'	=> $after_image_alt_text
				),
		...
		if ( $before_image_wrapper || $after_image_wrapper ) {
			...
			if ( 'on' === $show_slider_overlay ) {
				if ( 'color' === $slider_overlay_type ) {
					self::set_style(
						...
						array(
							...
							'declaration' => sprintf( 'background: %1$s !important;', esc_attr( $slider_overlay_bg_color ) ),
						)
					);
				} else {
					if ( 'linear-gradient' === $overlay_gradient_type ) {
						self::set_style(
							...
							array(
								'selector'    => '%%order_class%% .dipl-before-after-slider-wrapper .twentytwenty-overlay:hover',
								'declaration' => sprintf( 'background-image: linear-gradient(%1$s, %2$s %3$s, %4$s %5$s) !important;', esc_attr( $overlay_linear_direction ), esc_attr( $overlay_grandient_color_1 ), esc_attr( $overlay_gradient_start_position ), esc_html( $overlay_grandient_color_2 ), esc_attr( $overlay_gradient_end_position ) ),
							)
						);
					}
					...
					if ( 'radial-gradient' === $overlay_gradient_type ) {
						self::set_style(
							...
							array(
								'selector'    => '%%order_class%% .dipl-before-after-slider-wrapper .twentytwenty-overlay:hover',
								'declaration' => sprintf( 'background-image: radial-gradient(%1$s, %2$s %3$s, %4$s %5$s) !important;', esc_attr( $overlay_radial_direction ), esc_attr( $overlay_grandient_color_1 ), esc_attr( $overlay_gradient_start_position ), esc_attr( $overlay_grandient_color_2 ), esc_attr( $overlay_gradient_end_position ) ),
							)
						);
					}
				}
				...
				self::set_style(
					...
					array(
						'selector'    => '%%order_class%% .dipl-before-after-slider-wrapper .twentytwenty-overlay:hover',
						'declaration' => sprintf( 'background: transparent !important;' ),
					)
				);
			}
			...
			if ( '' !== $slider_handle_color ) {
				self::set_style(
					...
					array(
						...
						'declaration' => sprintf( 'border-color: %1$s !important;', esc_attr( $slider_handle_color ) ),
					)
				);
				self::set_style(
					$render_slug,
					array(
						...
						'declaration' => sprintf( 'border-bottom-color: %1$s !important;', esc_attr( $slider_handle_color ) ),
					)
				);
				self::set_style(
					$render_slug,
					array(
						...
						'declaration' => sprintf( 'border-top-color: %1$s !important;', esc_attr( $slider_handle_color ) ),
					)
				);
				self::set_style(
					$render_slug,
					array(
						...
						'declaration' => sprintf( 'border-right-color: %1$s !important;', esc_attr( $slider_handle_color ) ),
					)
				);
				self::set_style(
					$render_slug,
					array(
						...
						'declaration' => sprintf( 'border-left-color: %1$s !important;', esc_attr( $slider_handle_color ) ),
					)
				);
				self::set_style(
					$render_slug,
					array(
						...
						'declaration' => sprintf( 'background: %1$s !important;', esc_attr( $slider_handle_color ) ),
					)
				);
			}
			...
			if ( '' !== $before_label_bg && 'on' === $show_before_label ) {
				self::set_style(
					...
					array(
						...
						'declaration' => sprintf( 'background: %1$s !important;', esc_attr( $before_label_bg ) ),
					)
				);
			}
			...
			if ( '' !== $after_label_bg && 'on' === $show_after_label ) {
				self::set_style(
					...
					array(
						...
						'declaration' => sprintf( 'background: %1$s !important;', esc_attr( $after_label_bg ) ),
					)
				);
			}

			if ( 'off' === $show_before_label_on_hover ) {
				self::set_style(
					$render_slug,
					array(
						'selector'    => '%%order_class%% .dipl-before-after-slider-wrapper .twentytwenty-before-label',
						'declaration' => 'opacity: 1 !important;',
					)
				);
			}

			if ( 'off' === $show_after_label_on_hover ) {
				self::set_style(
					$render_slug,
					array(
						'selector'    => '%%order_class%% .dipl-before-after-slider-wrapper .twentytwenty-after-label',
						'declaration' => 'opacity: 1 !important;',
					)
				);
			}
        	...
        	wp_enqueue_style( 'dipl-before-after-slider-style', ELICUS_DIVI_PLUS_PLUGIN_URL . 'includes/modules/BeforeAfterSlider/' . $file . '.min.css', array(), '1.0.0' );
