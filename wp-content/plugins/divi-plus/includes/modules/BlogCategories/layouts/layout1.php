 ...
 *
 * This template can be overridden by copying it to yourtheme/divi-plus/layouts/blog-categories/layout1.php
 *
...
$category_items .= sprintf(
	'<div class="dipl_blog_category_item_inner">
		<div class="dipl_blog_category_content">%1$s %2$s</div>
	</div>
	<a href="%3$s" class="dipl_abs_link">%4$s</a>',
