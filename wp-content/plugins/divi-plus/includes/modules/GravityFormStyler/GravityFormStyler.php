...
class DIPL_GravityFormStyler extends ET_Builder_Module {
	...
	public function get_fields() {
		...
		return array_merge( array(
				...
				'submit_align' => array(
					'label'            => esc_html__( 'Submit Button Alignment', 'divi-plus' ),
					'type'             => 'text_align',
					'option_category'  => 'layout',
					...
					'tab_slug'         => 'advanced',
					'toggle_slug'      => 'submit_button',
					'description'      => esc_html__( 'Here you can choose the submit button alignment.', 'divi-plus' ),
	...
	public function render( $attrs, $content, $render_slug ) {
		...
		if ( 'left' === $this->props['submit_align'] ) {
			self::set_style( $render_slug, array(
				'selector'    => "{$this->main_css_element} div form .gform_footer",
        ...
        wp_enqueue_style( 'dipl-gravity-form-styler-style', ELICUS_DIVI_PLUS_PLUGIN_URL . 'includes/modules/GravityFormStyler/' . $file . '.min.css', array(), '1.0.0' );
