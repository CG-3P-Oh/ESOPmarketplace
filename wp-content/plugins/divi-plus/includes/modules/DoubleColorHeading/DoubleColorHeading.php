...
class DIPL_DoubleColorHeading extends ET_Builder_Module {
	...
	public function get_fields() {
		...
		$dipl_heading_fields = array(
			...
			'main_part_custom_padding'  => array(
				...
				'mobile_options'   => true,
				'tab_slug'         => 'advanced',
				'default'          => '|5px||5px|on|on',
				'default_on_front' => '|5px||5px|on|on',
				'toggle_slug'      => 'text_styling_settings',
				'sub_toggle'       => 'main_part_styling',
	...
	public function render( $attrs, $content, $render_slug ) {
		...
		if ( '' !== $heading_main_part && 'off' === $display_in_stack ) {
			...
			// );
			$main_part = sprintf(
				'<span class="dipl_main_text">%1$s</span>',
				esc_html( trim( $heading_main_part ) )
			);
		}
        ...
        wp_enqueue_style( 'dipl-fancy-heading-style', ELICUS_DIVI_PLUS_PLUGIN_URL . 'includes/modules/DoubleColorHeading/' . $file . '.min.css', array(), '1.0.0' );
