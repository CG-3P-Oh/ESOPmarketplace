...
class DIPL_HotSpot extends ET_Builder_Module {
		...
		return '<script type="text/javascript">
                jQuery(document).ready( function($) {
					...
					var triggerType = isTouchDevice 
						? "click"   // Mobile/tablet
						: "' . et_core_esc_previously( $props['trigger_event'] ) . '";  // Desktop
	...
	public function render( $attrs, $content, $render_slug ) {
        ...
        wp_enqueue_style( 'dipl-hotspot-style', ELICUS_DIVI_PLUS_PLUGIN_URL . 'includes/modules/HotSpot/' . $file . '.min.css', array(), '1.0.0' );
