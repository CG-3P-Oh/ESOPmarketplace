...
class DIPL_WooProductsAccordion extends ET_Builder_Module {
	...
	public function render( $attrs, $content, $render_slug ) {
		...
		wp_enqueue_style( 'dipl-woo-accordion-carousel-style', ELICUS_DIVI_PLUS_PLUGIN_URL . 'includes/modules/WooProductsAccordion/' . $file . '.min.css', array(), '1.0.0' );
		...
		// Load the JS file
		wp_enqueue_script( 'dipl-woo-products-accordion', ELICUS_DIVI_PLUS_PLUGIN_URL . 'includes/modules/WooProductsAccordion/dipl-woo-products-accordion-custom.min.js', array('jquery'), '1.1.0', true );
