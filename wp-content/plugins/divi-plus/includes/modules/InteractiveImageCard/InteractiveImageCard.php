	...
	public function render( $attrs, $content, $render_slug ) {
		...
		if ( ! empty( array_filter( $border_size ) ) ) {
			if ( 'effect-roxy' === $layout || 'effect-oscar' === $layout ) {
				...
				et_pb_responsive_options()->generate_responsive_css( $border_size, $selector, 'border-width', $render_slug, '!important;', 'type' );
			}
			if ( 'effect-bubba' === $layout || 'effect-layla' === $layout ) {
				...
				et_pb_responsive_options()->generate_responsive_css( $border_size, $before_selector, 'border-top-width', $render_slug, '!important;', 'type' );
				et_pb_responsive_options()->generate_responsive_css( $border_size, $before_selector, 'border-bottom-width', $render_slug, '!important;', 'type' );
				et_pb_responsive_options()->generate_responsive_css( $border_size, $after_selector, 'border-left-width', $render_slug, '!important;', 'type' );
				et_pb_responsive_options()->generate_responsive_css( $border_size, $after_selector, 'border-right-width', $render_slug, '!important;', 'type' );
			}
			if ( 'effect-romeo' === $layout ) {
				et_pb_responsive_options()->generate_responsive_css( $border_size, '%%order_class%% figure.effect-romeo figcaption::before', 'height', $render_slug, '!important;', 'type' );
				et_pb_responsive_options()->generate_responsive_css( $border_size, '%%order_class%% figure.effect-romeo figcaption::after', 'height', $render_slug, '!important;', 'type' );
			}
			if ( 'effect-marley' === $layout ) {
				et_pb_responsive_options()->generate_responsive_css( $border_size, '%%order_class%% figure.effect-marley h2::after', 'height', $render_slug, '!important;', 'type' );
			}
			...
			if ( 'effect-milo' === $layout ) {
				et_pb_responsive_options()->generate_responsive_css( $border_size, '%%order_class%% figure.effect-milo .dipl_interactive_image_card_wrapper_content', 'border-right-width', $render_slug, '!important;', 'type' );
			}
		}
		...
		if ( '' !== $border_color ) {
			self::set_style(
				...
				array(
					...
					'declaration' => sprintf( 'border-color: %1$s !important;', $border_color ),
				)
			);
			self::set_style(
				$render_slug,
				array(
					...
					'declaration' => sprintf( 'background: %1$s !important;', $border_color ),
				)
			);
		}
		...
		if ( '' !== $image_opacity ) {
			self::set_style(
				...
				array(
					...
					'declaration' => sprintf( 'opacity: %1$s !important;', $image_opacity ),
				)
			);
		}
		...
		if ( $image_opacity_hover ) {
			self::set_style(
				...
				array(
					...
					'declaration' => sprintf( 'opacity: %1$s !important;', $image_opacity_hover ),
				)
			);
		}
		...
		if ( 'on' === $enable_gradient ) {
			if ( 'linear-gradient' === $gradient_type ) {
				self::set_style(
					...
					array(
						...
						'declaration' => sprintf( 'background: linear-gradient(%1$s, %2$s %3$s, %4$s %5$s) !important;', esc_attr( $linear_direction ), esc_attr( $grandient_color_1 ), esc_attr( $gradient_start_position ), esc_attr( $grandient_color_2 ), esc_attr( $gradient_end_position ) ),
					)
				);
			}
			...
			if ( 'radial-gradient' === $gradient_type ) {
				self::set_style(
					...
					array(
						'selector'    => '%%order_class%% figure.effect-lily, %%order_class%% figure.effect-sadie figcaption::before, %%order_class%% figure.effect-roxy, %%order_class%% figure.effect-bubba, %%order_class%% figure.effect-layla, %%order_class%% figure.effect-oscar, %%order_class%% figure.effect-ruby, %%order_class%% figure.effect-milo',
						'declaration' => sprintf( 'background: radial-gradient(%1$s, %2$s %3$s, %4$s %5$s) !important;', esc_attr( $radial_direction ), esc_attr( $grandient_color_1 ), esc_attr( $gradient_start_position ), esc_attr( $grandient_color_2 ), esc_attr( $gradient_end_position ) ),
					)
				);
			}
			...
			if ( 'linear-gradient' === $gradient_type && ( isset( $grandient_color_1_hover ) || isset( $grandient_color_2_hover ) ) ) {
				self::set_style(
					...
					array(
						...
						'declaration' => sprintf( 'background: linear-gradient(%1$s, %2$s %3$s, %4$s %5$s) !important;', esc_attr( $linear_direction ), esc_attr( $grandient_color_1_hover ), esc_attr( $gradient_start_position ), esc_attr( $grandient_color_2_hover ), esc_attr( $gradient_end_position ) ),
					)
				);
			}
			...
			if ( 'radial-gradient' === $gradient_type && ( isset( $grandient_color_1_hover ) || isset( $grandient_color_2_hover ) ) ) {
				self::set_style(
					...
					array(
						'selector'    => '%%order_class%%:hover figure.effect-lily, %%order_class%%:hover figure.effect-sadie figcaption::before, %%order_class%%:hover figure.effect-roxy, %%order_class%%:hover figure.effect-bubba, %%order_class%%:hover figure.effect-layla, %%order_class%%:hover  figure.effect-oscar, %%order_class%%:hover figure.effect-ruby, %%order_class%%:hover figure.effect-milo',
						'declaration' => sprintf( 'background: radial-gradient(%1$s, %2$s %3$s, %4$s %5$s) !important;', esc_attr( $radial_direction ), esc_attr( $grandient_color_1_hover ), esc_attr( $gradient_start_position ), esc_attr( $grandient_color_2_hover ), esc_attr( $gradient_end_position ) ),
					)
				);
			}
		} else {
			if ( '' !== $overlay_color ) {
				self::set_style(
					...
					array(
						'selector'    => '%%order_class%% figure.effect-lily, %%order_class%% figure.effect-sadie figcaption::before, %%order_class%% figure.effect-roxy, %%order_class%% figure.effect-bubba, %%order_class%% figure.effect-layla, %%order_class%% figure.effect-oscar, %%order_class%% figure.effect-ruby, %%order_class%% figure.effect-milo',
						'declaration' => sprintf( 'background: %1$s !important;', $overlay_color ),
					)
				);
			}
			...
			if ( isset( $overlay_color_hover ) ) {
				self::set_style(
					...
					array(
						'selector'    => '%%order_class%%:hover figure.effect-lily, %%order_class%%:hover figure.effect-sadie figcaption::before, %%order_class%%:hover figure.effect-roxy, %%order_class%%:hover figure.effect-bubba, %%order_class%%:hover figure.effect-layla, %%order_class%%:hover figure.effect-oscar, %%order_class%%:hover figure.effect-ruby, %%order_class%%:hover figure.effect-milo',
						'declaration' => sprintf( 'background: %1$s !important;', $overlay_color_hover ),
					)
				);
			}
		}
        ...
        wp_enqueue_style( 'dipl-interactive-image-card-style', ELICUS_DIVI_PLUS_PLUGIN_URL . 'includes/modules/InteractiveImageCard/' . $file . '.min.css', array(), '1.0.0' );
