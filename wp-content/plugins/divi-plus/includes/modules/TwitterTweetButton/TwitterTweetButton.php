...
class DIPL_TwitterTweetButton extends ET_Builder_Module {
	...
	public function render( $attrs, $content, $render_slug ) {
		...
		//wp_enqueue_script( 'dipl-twitter-tweet-button-custom', ELICUS_DIVI_PLUS_PLUGIN_URL . 'includes/modules/TwitterTweetButton/dipl-twitter-tweet-button-custom.min.js', array('jquery'), '1.0.0', true );
		$file = et_is_builder_plugin_active() ? 'style-dbp' : 'style';
        wp_enqueue_style( 'dipl-twitter-tweet-button-style', ELICUS_DIVI_PLUS_PLUGIN_URL . 'includes/modules/TwitterTweetButton/' . $file . '.min.css', array(), '1.0.0' );
		$tweet_button = sprintf(
			'<div class="dipl_twitter_embedded_tweet_button">
				<a class="dipl_twitter_embed_tweet_button" href="https://x.com/intent/tweet" data-text="%1$s" data-url="%2$s" data-size="%3$s" data-dnt="%4$s" data-hashtags="%5$s" data-via="%6$s" data-related="%7$s">Tweet</a>
			</div>',
