...
class DIPL_FacebookPage extends ET_Builder_Module {
	...
	public function render( $attrs, $content, $render_slug ) {
		...
		$facebook_tabs = DiviPlusHelper::process_multiple_checkboxes_value( $facebook_tabs, $whitelisted_tabs );
		...
		if ( '' !== $facebook_app_id ) {
        	...
        	wp_enqueue_style( 'dipl-facebook-page-style', ELICUS_DIVI_PLUS_PLUGIN_URL . 'includes/modules/FacebookPage/' . $file . '.min.css', array(), '1.0.0' );
