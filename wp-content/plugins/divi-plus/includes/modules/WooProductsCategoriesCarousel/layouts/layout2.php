 ...
 *
 * This template can be overridden by copying it to yourtheme/divi-plus/layouts/woo-products-categories-carousel/layout2.php
 *
...
$category_items .= sprintf(
	'<div class="dipl_woo_product_category product_cat_%1$s %2$s">
		%3$s
        <div class="dipl_woo_product_category_content_wrapper">
