...
class DIPL_Breadcrumb extends ET_Builder_Module {
	...
	public function render( $attrs, $content, $render_slug ) {
		...
		$home_link_text                        = ! empty( $this->props['home_link_text'] ) ? sprintf( esc_html__( '%s', 'divi-plus' ), $this->props['home_link_text'] ) : esc_html__( 'Home', 'divi-plus' );
		...
		if ( ! empty( array_filter( $breadcrumb_alignment ) ) ) {
			et_pb_responsive_options()->generate_responsive_css( $breadcrumb_alignment, '%%order_class%% .dipl-breadcrumb-wrapper', 'justify-content', $render_slug, '!important;', 'type' );
		}

		if ( ! empty( array_filter( $home_link_icon_size ) ) ) {
			et_pb_responsive_options()->generate_responsive_css( $home_link_icon_size, '%%order_class%% .dipl-breadcrumb-wrapper li .breadcrumb-home-icon', 'font-size', $render_slug, '!important;', 'type' );
		}
		...
		if ( '' !== $home_link_icon_color ) {
			self::set_style(
				...
				array(
					'selector'    => '%%order_class%% .dipl-breadcrumb-wrapper li .breadcrumb-home-icon',
					'declaration' => sprintf( 'color: %1$s !important;', esc_html( $home_link_icon_color ) ),
				)
			);
		}
		...
		if ( isset( $home_link_icon_color_hover ) ) {
			self::set_style(
				...
				array(
					...
					'declaration' => sprintf( 'color: %1$s !important;', esc_html( $home_link_icon_color_hover ) ),
				)
			);
		}
		...
		if ( 'layout1' === $breadcrumb_layout && '' !== $breadcrumb ) {
			if ( '' !== $padding_desktop['left'] ) {
				self::set_style(
					...
					array(
						...
						'declaration' => sprintf( 'padding-left: %1$spx !important;', esc_html( $padding_desktop['left'] ) ),
					)
				);
				self::set_style(
					$render_slug,
					array(
						'selector'    => '%%order_class%% .dipl-breadcrumb-wrapper.layout1 li .breadcrumb-page',
						'declaration' => sprintf( 'padding-left: %1$spx !important;', esc_html( $padding_tablet['left'] ) ),
				...
				self::set_style(
					...
					array(
						'selector'    => '%%order_class%% .dipl-breadcrumb-wrapper.layout1 li .breadcrumb-page',
						'declaration' => sprintf( 'padding-left: %1$spx !important;', esc_html( $padding_phone['left'] ) ),
			...
			if ( '' !== $padding_desktop['right'] ) {
				self::set_style(
					...
					array(
						'selector'    => '%%order_class%% .dipl-breadcrumb-wrapper.layout1 li .breadcrumb-page',
						'declaration' => sprintf( 'padding-right: %1$spx !important;', esc_html( $padding_desktop['right'] ) ),
					)
				);
				self::set_style(
					$render_slug,
					array(
						'selector'    => '%%order_class%% .dipl-breadcrumb-wrapper.layout1 li .breadcrumb-page',
						'declaration' => sprintf( 'padding-right: %1$spx !important;', esc_html( $padding_tablet['right'] ) ),
						'media_query' => ET_Builder_Element::get_media_query( 'max_width_980' ),
					)
				);
				self::set_style(
					...
					array(
						'selector'    => '%%order_class%% .dipl-breadcrumb-wrapper.layout1 li .breadcrumb-page',
						'declaration' => sprintf( 'padding-right: %1$spx !important;', esc_html( $padding_phone['right'] ) ),
						'media_query' => ET_Builder_Element::get_media_query( 'max_width_767' ),
					)
				);
			}
			if ( '' !== $nav_bg_color ) {
				self::set_style(
					...
					array(
						'selector'    => '%%order_class%% .dipl-breadcrumb-wrapper.layout1 li .breadcrumb-page',
						'declaration' => sprintf( 'background-color: %1$s !important;', esc_html( $nav_bg_color ) ),
					)
				);
				self::set_style(
					$render_slug,
					array(
						...
						'declaration' => sprintf( 'border-color: transparent transparent transparent %1$s !important;', esc_html( $nav_bg_color ) ),
					)
				);
				self::set_style(
					$render_slug,
					array(
						...
						'declaration' => sprintf( 'border-color: %1$s %1$s %1$s transparent !important', esc_html( $nav_bg_color ) ),
					)
				);
			}
			...
			if ( isset( $nav_bg_color_hover ) ) {
				self::set_style(
					...
					array(
						...
						'declaration' => sprintf( 'background-color: %1$s !important;', esc_html( $nav_bg_color_hover ) ),
					)
				);
				self::set_style(
					$render_slug,
					array(
						...
						'declaration' => sprintf( 'border-color: transparent transparent transparent %1$s !important;', esc_html( $nav_bg_color_hover ) ),
					)
				);
				self::set_style(
					$render_slug,
					array(
						...
						'declaration' => sprintf( 'border-color: %1$s %1$s %1$s transparent !important;', esc_html( $nav_bg_color_hover ) ),
					)
				);
			}
			...
			if ( '' !== $nav_last_item_bg_color && 'on' === $enable_different_bg ) {
				self::set_style(
					...
					array(
						...
						'declaration' => sprintf( 'background-color: %1$s !important;', esc_html( $nav_last_item_bg_color ) ),
					)
				);
				self::set_style(
					$render_slug,
					array(
						...
						'declaration' => sprintf( 'border-color: transparent transparent transparent %1$s !important;', esc_html( $nav_last_item_bg_color ) ),
					)
				);
				self::set_style(
					$render_slug,
					array(
						...
						'declaration' => sprintf( 'border-color: %1$s %1$s %1$s transparent !important;', esc_html( $nav_last_item_bg_color ) ),
					)
				);
			}
			...
			if ( '' !== $this->props['global_text_settings_font_size'] ) {
				...
				self::set_style(
					...
					array(
						'selector'    => '%%order_class%% .dipl-breadcrumb-wrapper.layout1 li .breadcrumb-page',
						'declaration' => sprintf( 'height: %1$s !important;', esc_html( $height ) ),
					)
				);
				self::set_style(
					$render_slug,
					array(
						...
						'declaration' => sprintf( 'border-width: %1$s 10px %2$s 10px !important;', esc_html( $height_f ), esc_html( $height_c ) ),
					)
				);
			}
		...
		if ( 'layout2' === $breadcrumb_layout && '' !== $breadcrumb ) {
			if ( 'text_separator' === $separator_type ) {
				self::set_style(
					...
					array(
						...
						'declaration' => sprintf( 'content: "%1$s" !important;', esc_html( $separator_text ) ),
					)
				);
			} else {
				self::set_style(
			...
			if ( ! empty( array_filter( $separator_size ) ) ) {
				et_pb_responsive_options()->generate_responsive_css( $separator_size, '%%order_class%% .dipl-breadcrumb-inner li:after', 'font-size', $render_slug, '!important;', 'type' );
			}
			...
			if ( '' !== $separator_color ) {
				self::set_style(
					...
					array(
						'selector'    => '%%order_class%% .dipl-breadcrumb-inner li:after',
						'declaration' => sprintf( 'color: %1$s !important;', esc_html( $separator_color ) ),
					)
				);
			}
			...
			if ( isset( $separator_color_hover ) ) {
				self::set_style(
					...
					array(
						...
						'declaration' => sprintf( 'color: %1$s !important;', esc_html( $separator_color_hover ) ),
					)
				);
			}
        ...
        wp_enqueue_style( 'dipl-breadcrumb-style', ELICUS_DIVI_PLUS_PLUGIN_URL . 'includes/modules/Breadcrumb/' . $file . '.min.css', array(), '1.0.0' );
