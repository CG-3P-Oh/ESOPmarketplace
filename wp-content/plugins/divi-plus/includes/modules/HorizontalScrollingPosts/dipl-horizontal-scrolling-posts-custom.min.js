jQuery( document ).ready( function($) {
	...
	if ( $( '.dipl_horizontal_scrolling_posts' ).length > 0 ) {
		gsap.registerPlugin( ScrollTrigger );
		$( document ).find('.dipl_horizontal_scrolling_posts').each( function() {
			let $section         = $( this ),
				$container       = $section.find('.dipl-sticky-posts-wrapper'),
				$scroller        = $section.find( '.dipl-sticky-posts-scroller' ),
