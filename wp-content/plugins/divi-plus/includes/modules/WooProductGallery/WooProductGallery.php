...
class DIPL_WooProductGallery extends ET_Builder_Module {
	...
	public function render( $attrs, $content, $render_slug ) {
		...
		if ( 'masonry' === $layout || 'on' === $enable_lightbox ) {
			wp_enqueue_script( 'dipl-woo-product-gallery-script', ELICUS_DIVI_PLUS_PLUGIN_URL . 'includes/modules/WooProductGallery/dipl-woo-product-gallery-custom.min.js', array('jquery'), '1.0.0', true );
		}

		$file = et_is_builder_plugin_active() ? 'style-dbp' : 'style';
		wp_enqueue_style( 'dipl-woo-product-gallery-style', ELICUS_DIVI_PLUS_PLUGIN_URL . 'includes/modules/WooProductGallery/' . $file . '.min.css', array(), '1.0.0' );
		...
		if ( 'masonry' == $layout ) {
			...
			et_pb_responsive_options()->generate_responsive_css( $width, '%%order_class%% .dipl-layout-masonry .dipl-column-item', 'width', $render_slug, '!important;', 'type' );
