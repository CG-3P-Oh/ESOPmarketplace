 ...
 * @version    1.18.0
 */
class DIPL_WooBrandsCarousel extends ET_Builder_Module {
	public $slug       = 'dipl_woo_brands_carousel';
	...
	public function init() {
		$this->name             = esc_html__( 'DP Woo Brands Carousel', 'divi-plus' );
		...
		return array(
			'fonts' => array(
				'name' => array(
					...
					'css'            => array(
						'main'       => "{$this->main_css_element} .dipl_woo_product_brand_name, {$this->main_css_element} .dipl_woo_product_brand_name a",
						'important' => 'all',
					),
					'tab_slug'	  => 'advanced',
					'toggle_slug' => 'name_text',
				),
				'product_count' => array(
					...
					'css'            => array(
						'main'       => "{$this->main_css_element} .dipl_woo_product_brand_count, {$this->main_css_element} .dipl_woo_product_brand_count a",
						'important' => 'all',
					),
			...
			'borders' => array(
				'thumbnail' => array(
					...
					'css' => array(
						'main' => array(
							'border_radii'  => "%%order_class%% .dipl_woo_product_brand_thumbnail",
							'border_styles' => "%%order_class%% .dipl_woo_product_brand_thumbnail",
						),
						'important' => 'all',
					),
					'tab_slug'    => 'advanced',
				...
				'content_box' => array(
					...
					'css' => array(
						'main' => array(
							'border_radii'  => "%%order_class%% .dipl_woo_product_brand_content",
							'border_styles' => "%%order_class%% .dipl_woo_product_brand_content",
						),
						'important' => 'all',
					),
					'tab_slug'    => 'advanced',
				...
				'brand_item' => array(
					'label_prefix' => esc_html__( 'Brand', 'divi-plus' ),
					'css' => array(
						'main' => array(
							'border_radii'  => "%%order_class%% .dipl_woo_products_brand_item",
							'border_styles' => "%%order_class%% .dipl_woo_products_brand_item",
						),
						'important' => 'all',
					),
					'tab_slug'    => 'advanced',
					'toggle_slug' => 'brand_item',
				),
				'arrows' => array(
					'css' => array(
						'main' => array(
			...
			'box_shadow' => array(
				'thumbnail' => array(
					...
					'css'         => array(
						'main'      => "%%order_class%% .dipl_woo_product_brand_thumbnail",
						'important' => 'all',
					),
					'tab_slug'    => 'advanced',
					'toggle_slug' => 'thumbnail',
				...
				'brand_item' => array(
					'label'       => esc_html__( 'Brand Box Shadow', 'divi-plus' ),
					'css'         => array(
						'main'      => "%%order_class%% .dipl_woo_products_brand_item",
						'important' => 'all',
					),
					'tab_slug'    => 'advanced',
					'toggle_slug' => 'brand_item',
			...
			'brands_carousel_spacing' => array(
				'thumbnail' => array(
					'margin_padding' => array(
						'css' => array(
							'use_margin' => false,
							'padding'    => "%%order_class%% .dipl_woo_product_brand_thumbnail",
							'important'  => 'all',
						),
					),
				),
				'content_box' => array(
					'margin_padding' => array(
						'css' => array(
							'use_margin' => false,
							'padding'    => "%%order_class%% .dipl_woo_product_brand_content",
							'important'  => 'all',
						),
					),
				),
				'brand_item' => array(
					'margin_padding' => array(
						'css' => array(
							'use_margin' => false,
							'padding'    => "%%order_class%% .dipl_woo_products_brand_item",
							'important'  => 'all',
						),
					),
				),
				'slider_container' => array(
					'margin_padding' => array(
						'css' => array(
							'use_margin' => false,
							'padding'    => "%%order_class%% .dipl_woo_products_brand_wrap .swiper-container",
							'important'  => 'all',
						),
					),
				),
		...
		return array_merge(
			array(
				'include_brands' => array(
					'label'            => esc_html__( 'Include Brands', 'divi-plus' ),
					'type'             => 'categories',
					'renderer_options' => array(
						'use_terms'  => true,
						'term_name'  => 'product_brand',
						'field_name' => 'et_pb_include_dipl_product_brand',
					),
					'toggle_slug'      => 'main_content',
					'description'      => esc_html__( 'Select Brands. If no brand is selected, all brands will be displayed.', 'divi-plus' ),
					'computed_affects' => array(
						'__products_brands_data',
					),
				),
				'order_by' => array(
					...
					'default'          => 'name',
					'toggle_slug'      => 'main_content',
					'description'      => esc_html__( 'Here you can specify the order in which the brands will be displayed.', 'divi-plus' ),
					'computed_affects' => array(
						'__products_brands_data',
					),
				),
				'order' => array(
					...
					'toggle_slug'      => 'main_content',
					'description'      => esc_html__( 'Here you can specify the sorting order for the brands.', 'divi-plus' ),
					'computed_affects' => array(
						'__products_brands_data',
					),
				),
				...
				'no_result_text' => array(
					...
					'type'             => 'text',
					'option_category'  => 'configuration',
					'default'		   => esc_html__( 'The brands you requested could not be found. Try changing your module settings or create some new brands.', 'divi-plus' ),
					'toggle_slug'      => 'main_content',
				...
				'show_thumbnail' => array(
					...
					'default'         => 'on',
					'toggle_slug'     => 'display',
					'description'     => esc_html__( 'Choose whether or not the product brand thumbnail should be visible.', 'divi-plus' ),
					'computed_affects' => array(
						'__products_brands_data',
					),
				),
				'thumbnail_size' => array(
					...
					'toggle_slug'      => 'display',
					'description'      => esc_html__( 'Here you can specify the size of brand image.', 'divi-plus' ),
					'computed_affects' => array(
						'__products_brands_data',
					),
				),
				...
				'items_per_slide' => array(
					'label'           => esc_html__( 'Number of Brands Per View', 'divi-plus' ),
					'type'            => 'select',
				...
				'thumbnail_custom_padding' => array(
					...
					'default_on_front' => '15px|15px|15px|15px|on|on',
					'mobile_options'   => true,
					'hover'            => false,
					'show_if'          => array( 'show_thumbnail' => 'on' ),
					'tab_slug'         => 'advanced',
				...
				'brand_item_custom_padding' => array(
					'label'            => esc_html__( 'Brand Padding', 'divi-plus' ),
					'type'             => 'custom_padding',
					'option_category'  => 'layout',
					'default'		   => '||||on|on',
				...
				'brand_background_bg_color' => array(
					'label'             => esc_html__( 'Item Background', 'divi-plus' ),
					'type'              => 'background-field',
					'base_name'         => 'brand_background_bg',
					'context'           => 'brand_background_bg_color',
					'option_category'   => 'button',
					'custom_color'      => true,
					'background_fields' => $this->generate_background_options( 'brand_background_bg', 'button', 'advanced', 'brand_item', 'brand_background_bg_color' ),
					'hover'             => true,
					'mobile_options'    => true,
					'tab_slug'          => 'advanced',
					'toggle_slug'       => 'brand_item',
					'description'       => esc_html__( 'Here you can set the background brand item, color, and gradient to show on mouse hover.', 'divi-plus' ),
				),
				...
				'__products_brands_data' => array(
					'type'                => 'computed',
					'computed_callback'   => array( 'DIPL_WooBrandsCarousel', 'get_brands_computed_data' ),
			...
			$this->generate_background_options( 'brand_background_bg', 'skip', 'advanced', 'brand_item', 'brand_background_bg_color' ),
		);
	}
	 ...
	 */
	public static function get_brands_computed_data( $args = array(), $conditional_tags = array(), $current_page = array() ) {
		$defaults = array(
			'layout'             => 'layout1',
			'include_brands'     => '',
			'order_by'           => 'name',
		...
		if ( $product_brands && ! is_wp_error( $product_brands ) ) {
			...
			// Check recount requires.
			$all_count = wp_list_pluck( $product_brands, 'count' );
			if ( 'on' === $show_product_count && in_array( 0, $all_count, true ) ) {
				self::recount_brands_product_count();
			}

			foreach ( $product_brands as $product_brand ) {

				$brand_link = get_term_link( intval( $product_brand->term_id ), 'product_brand' );

				$brand_items = '';
				if ( file_exists( get_stylesheet_directory() . '/divi-plus/layouts/woo-brands-carousel/' . sanitize_file_name( $layout ) . '.php' ) ) {
					include get_stylesheet_directory() . '/divi-plus/layouts/woo-brands-carousel/' . sanitize_file_name( $layout ) . '.php';
				...
				array_push( $output_array, $brand_items );
			}
		}
	...
	public function render( $attrs, $content, $render_slug ) {
		...
		// Get attributes.
		$include_brands     = sanitize_text_field( $this->props['include_brands'] ) ?? '';
		$order_by           = sanitize_text_field( $this->props['order_by'] ) ?? 'name';
		$order              = sanitize_text_field( $this->props['order'] ) ?? 'ASC';
		$hide_empty         = sanitize_text_field( $this->props['hide_empty'] ) ?? 'off';

		$show_thumbnail     = sanitize_text_field( $this->props['show_thumbnail'] ) ?? 'on';
		$thumbnail_size     = sanitize_text_field( $this->props['thumbnail_size'] ) ?? 'woocommerce_thumbnail';
		$show_product_count = sanitize_text_field( $this->props['show_product_count'] ) ?? 'on';
		...
		// Get the title level.
		$title_level        = et_pb_process_header_level( $this->props['name_level'], 'h4' );
		...
		// Check if brands founds.
		$layout = 'layout1';
		if ( $product_brands && ! is_wp_error( $product_brands ) ) {

			// Load the scripts.
			$file = et_is_builder_plugin_active() ? 'style-dbp' : 'style';
        	wp_enqueue_style( 'dipl-woo-brands-carousel-style', ELICUS_DIVI_PLUS_PLUGIN_URL . 'includes/modules/WooBrandsCarousel/' . $file . '.min.css', array(), '1.0.0' );
			...
			foreach ( $product_brands as $product_brand ) {
				...
				$brand_items .= '<div class="swiper-slide dipl_woo_products_brand_item">';
				if ( file_exists( get_stylesheet_directory() . '/divi-plus/layouts/woo-brands-carousel/' . sanitize_file_name( $layout ) . '.php' ) ) {
					include get_stylesheet_directory() . '/divi-plus/layouts/woo-brands-carousel/' . sanitize_file_name( $layout ) . '.php';
				} elseif ( file_exists( plugin_dir_path( __FILE__ ) . 'layouts/' . sanitize_file_name( $layout ) . '.php' ) ) {
					include plugin_dir_path( __FILE__ ) . 'layouts/' . sanitize_file_name( $layout ) . '.php';
			...
			if ( 'on' === $show_arrow ) {
				...
				if ( ! empty( $arrows_position ) ) {
					wp_enqueue_script( 'dipl-woo-brands-carousel-custom', ELICUS_DIVI_PLUS_PLUGIN_URL . "includes/modules/WooBrandsCarousel/dipl-woo-brands-carousel-custom.min.js", array('jquery'), '1.0.1', true );
			...
			$render_output = sprintf(
				'<div class="dipl_woo_products_brand_wrap dipl_swiper_wrapper %1$s">
					<div class="dipl_swiper_inner_wrap">
				...
				esc_attr( $layout ),
				et_core_esc_previously( $brand_items ),
			...
			if ( 'on' === $show_thumbnail ) {
				$thumbnail_width = et_pb_responsive_options()->get_property_values( $this->props, 'thumbnail_width' );
				if ( ! empty( array_filter( $thumbnail_width ) ) ) {
					et_pb_responsive_options()->generate_responsive_css( $thumbnail_width, '%%order_class%% .dipl_woo_product_brand_thumbnail img', 'width', $render_slug, '!important;', 'range' );
				}
				if ( ! empty( $this->props['thumbnail_bg_color'] ) ) {
					$this->generate_styles( array(
						'base_attr_name' => 'thumbnail_bg_color',
						'selector'       => '%%order_class%% .dipl_woo_product_brand_thumbnail',
						'hover_selector' => '%%order_class%% .dipl_woo_product_brand_thumbnail:hover',
			...
			if ( ! empty( $this->props['content_box_bg_color'] ) ) {
				$this->generate_styles( array(
					...
					'selector'       => '%%order_class%% .dipl_woo_product_brand_content',
					'hover_selector' => '%%order_class%% .dipl_woo_product_brand_content:hover',
					'css_property'   => 'background',
					'render_slug'    => $render_slug,
					'type'           => 'color',
				) );
			...
			if ( 'on' === $show_arrow ) {
				...
				if ( '' !== $this->props['next_slide_arrow'] ) {
					self::set_style( $render_slug, array(
						'selector'    => '%%order_class%% .dipl_woo_products_brand_wrap .dipl_swiper_navigation .swiper-button-next::after',
				...
				if ( '' !== $this->props['previous_slide_arrow'] ) {
					self::set_style( $render_slug, array(
						'selector'    => '%%order_class%% .dipl_woo_products_brand_wrap .dipl_swiper_navigation .swiper-button-prev::after',
			...
			$fields = array( 'brands_carousel_spacing' );
			...
			$args = array(
				...
				'module'		=> $this,
				'backgrounds' 	=> array(
					'brand_background_bg' => array(
						'normal' => "{$this->main_css_element} .dipl_woo_products_brand_item",
						'hover' => "{$this->main_css_element} .dipl_woo_products_brand_item:hover",
					)
				),
			);
	...
	public function dipl_render_slider_script() {
		$order_class     		= $this->get_module_order_class( 'dipl_woo_brands_carousel' );
	...
	/**
	 * Recount the brands product count.
	 */
	public static function recount_brands_product_count() {
		// Optional: Force WooCommerce to recalc counts (if needed).
		$count = get_terms( array(
			'taxonomy'   => 'product_brand',
			'hide_empty' => false,
			'fields'     => 'id=>parent',
		) );
		_wc_term_recount( $count, get_taxonomy( 'product_brand' ), true, false );
	}
}
...
if ( isset( $plugin_options['dipl-modules'] ) ) {
	...
	if ( in_array( 'dipl_woo_brands_carousel', $modules ) ) {
		new DIPL_WooBrandsCarousel();
	}
} else {
	new DIPL_WooBrandsCarousel();
}
