...
$output .= sprintf(
	'<div id="dipl_team_member_grid_%2$s" class="%7$s" 
		data-padding_top_desktop="%9$s"
		data-padding_top_tablet="%10$s"
		data-padding_top_phone="%11$s"
		data-padding_bottom_desktop="%12$s"
		data-padding_bottom_tablet="%13$s"
		data-padding_bottom_phone="%14$s"
	%8$s>
		<div class="dipl_team_member_image_wrapper">
			%1$s %6$s
		</div>
		<div class="dipl_team_content_wrapper">%3$s %4$s %5$s</div>
	</div>', 
