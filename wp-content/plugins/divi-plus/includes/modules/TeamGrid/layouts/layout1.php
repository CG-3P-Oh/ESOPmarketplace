 ...
 *
 * This template can be overridden by copying it to yourtheme/divi-plus/layouts/team-grid/layout1.php
 *
...
if ( $short_description || $social_icons || $readmore_button ) {
	$hidden_content = sprintf(
		'<div class="dipl_team_member_hidden_wrapper">%1$s %2$s %3$s</div>',
...
$output .= sprintf(
	'<div id="dipl_team_member_grid_%2$s" class="%5$s" 
		data-padding_top_desktop="%7$s"
		data-padding_top_tablet="%8$s"
		data-padding_top_phone="%9$s"
		data-padding_bottom_desktop="%10$s"
		data-padding_bottom_tablet="%11$s"
		data-padding_bottom_phone="%12$s"
	%6$s>
		%1$s
	...
	$short_description || $social_icons || $readmore_button ? $hidden_content : '',
