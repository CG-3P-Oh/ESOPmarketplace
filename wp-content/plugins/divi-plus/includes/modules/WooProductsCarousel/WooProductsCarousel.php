...
class DIPL_WooProductsCarousel extends ET_Builder_Module {
	...
	public function render( $attrs, $content, $render_slug ) {
		...
		if ( $query->have_posts() ) {
			...
			wp_enqueue_script( 'dipl-woo-products-carousel-custom', ELICUS_DIVI_PLUS_PLUGIN_URL . "includes/modules/WooProductsCarousel/dipl-woo-products-carousel-custom.min.js", array('jquery'), '1.0.3', true );
        	...
        	wp_enqueue_style( 'dipl-woo-products-carousel-style', ELICUS_DIVI_PLUS_PLUGIN_URL . 'includes/modules/WooProductsCarousel/' . $file . '.min.css', array(), '1.0.0' );
        	wp_enqueue_style( 'dipl-woo-products-style', ELICUS_DIVI_PLUS_PLUGIN_URL . 'includes/modules/WooProducts/' . $file . '.min.css', array(), '1.0.0' );
