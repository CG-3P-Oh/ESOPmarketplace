...
class DIPL_FilterableGallery extends ET_Builder_Module {
	...
	public function render( $attrs, $content, $render_slug ) {
		...
		if ( $query->have_posts() ) {
			...
			wp_enqueue_script( 'dipl-filterable-gallery-custom', ELICUS_DIVI_PLUS_PLUGIN_URL . 'includes/modules/FilterableGallery/dipl-filterable-gallery-custom.min.js', array('jquery'), '1.0.2', true );

			$file = et_is_builder_plugin_active() ? 'style-dbp' : 'style';
        	wp_enqueue_style( 'dipl-filterable-gallery-style', ELICUS_DIVI_PLUS_PLUGIN_URL . 'includes/modules/FilterableGallery/' . $file . '.min.css', array(), '1.0.0' );
