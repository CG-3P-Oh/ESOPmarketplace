 ...
 *
 * This template can be overridden by copying it to yourtheme/divi-plus/layouts/advanced-counter/layout2.php
 *
...
$counter_output = sprintf(
	'<div class="dipl_advanced_counter_inner">
		<div class="dipl_advanced_counter_inner_top">
			%1$s <div class="dipl_advanced_counter_inner_content">%2$s %3$s</div>
		</div>
		%4$s
	</div>',
	et_core_esc_previously( $image_icon ),
