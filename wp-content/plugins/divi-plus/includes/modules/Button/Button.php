...
class DIPL_Button extends ET_Builder_Module {
    ...
    public function render( $attrs, $content, $render_slug ) {
        ...
        wp_enqueue_script( 'dipl-button-custom', ELICUS_DIVI_PLUS_PLUGIN_URL . "includes/modules/Button/dipl-button-custom.min.js", array('jquery'), '1.0.0', true );
        ...
        if ( ! empty( array_filter( $buttons_alignment_values ) ) ) {
            ...
            et_pb_responsive_options()->generate_responsive_css( $buttons_alignment_values, $alignment_selector, 'text-align', $render_slug, '!important;', 'type' );
        }
        ...
        et_pb_responsive_options()->generate_responsive_css( $button_icon_color_values, $icon_selector, 'color', $render_slug, '!important;', 'type' );
