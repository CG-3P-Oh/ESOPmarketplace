...
class DIPL_ImageAccordion extends ET_Builder_Module {
	...
	public function render( $attrs, $content, $render_slug ) {
        ...
        wp_enqueue_script( 'dipl-image-accordion-custom', ELICUS_DIVI_PLUS_PLUGIN_URL . "includes/modules/ImageAccordion/dipl-image-accordion-custom.min.js", array('jquery'), '1.0.0', true );
        $file = et_is_builder_plugin_active() ? 'style-dbp' : 'style';
        wp_enqueue_style( 'dipl-image-accordion-style', ELICUS_DIVI_PLUS_PLUGIN_URL . 'includes/modules/ImageAccordion/' . $file . '.min.css', array(), '1.0.0' );
        ...
        self::set_style( $render_slug, array(
            ...
            'declaration'   => sprintf(
                'transition-duration: %1$s !important;',
		...
		if ( ! empty( $inactive_state ) ) {		
			...
			if ( in_array( 'icon', $inactive_state, true ) ) { 
				self::set_style( $render_slug, array(
