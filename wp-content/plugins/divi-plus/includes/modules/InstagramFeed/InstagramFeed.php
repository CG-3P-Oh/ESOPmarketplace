...
class DIPL_InstagramFeed extends ET_Builder_Module {
	...
	public function render( $attrs, $content, $render_slug ) {
		...
		if ( 'masonry' === $layout ) {
			...
			wp_enqueue_script( 'dipl-instagram-feed-script', ELICUS_DIVI_PLUS_PLUGIN_URL . 'includes/modules/InstagramFeed/instagram-feed.min.js', array( 'jquery' ), '1.0.0', true );
		}

		// Load css file
		$file = et_is_builder_plugin_active() ? 'style-dbp' : 'style';
		wp_enqueue_style( 'dipl-instagram-feed-style', ELICUS_DIVI_PLUS_PLUGIN_URL . 'includes/modules/InstagramFeed/' . $file . '.min.css', array(), '1.0.0' );
