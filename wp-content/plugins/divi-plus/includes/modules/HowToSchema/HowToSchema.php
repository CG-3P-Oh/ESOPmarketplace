...
class DIPL_HowToSchema extends ET_Builder_Module {
		...
		return array(
			'fonts'          => array(
				'how_to_heading'             => array(
					...
					'css'            => array(
						'main' => '%%order_class%% .dipl_how_to_title h1, %%order_class%% .dipl_how_to_title h2, %%order_class%% .dipl_how_to_title h3, %%order_class%% .dipl_how_to_title h4, %%order_class%% .dipl_how_to_title h5, %%order_class%% .dipl_how_to_title h6',
						'important' => 'all',
					),
	...
	public function render( $attrs, $content, $render_slug ) {
        ...
        wp_enqueue_style( 'dipl-how-to-schema-style', ELICUS_DIVI_PLUS_PLUGIN_URL . 'includes/modules/HowToSchema/' . $file . '.min.css', array(), '1.0.0' );
