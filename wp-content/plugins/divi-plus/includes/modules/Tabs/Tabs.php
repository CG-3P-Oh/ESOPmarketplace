...
class DIPL_Tabs extends ET_Builder_Module {
	...
	public function render( $attrs, $content, $render_slug ) {
		...
		wp_enqueue_script( 'dipl-tabs-custom', ELICUS_DIVI_PLUS_PLUGIN_URL . 'includes/modules/Tabs/dipl-tabs-custom.min.js', array('jquery'), '1.0.1', true );
		$file = et_is_builder_plugin_active() ? 'style-dbp' : 'style';
        wp_enqueue_style( 'dipl-tabs-style', ELICUS_DIVI_PLUS_PLUGIN_URL . 'includes/modules/Tabs/' . $file . '.min.css', array(), '1.0.0' );
