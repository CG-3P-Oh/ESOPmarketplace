...
class DIPL_WooProducts extends ET_Builder_Module {
	...
	public static function get_products_data( $args = array(), $conditional_tags = array(), $current_page = array() ) {
		...
		if ( $query->have_posts() ) {
			...
			if ( 'on' === $show_sorting_dropdown ) {
				...
				$sorting_options = apply_filters( 'dipl_woo_products_orderby_options', $sorting_options );
	...
	public function render( $attrs, $content, $render_slug ) {
		...
		$products_number = ( 0 === $products_number ) ? -1 : (int) $products_number;
		wp_enqueue_script( 'dipl-woo-products-custom', ELICUS_DIVI_PLUS_PLUGIN_URL . 'includes/modules/WooProducts/dipl-woo-products-custom.min.js', array('jquery'), '1.1.0', true );
