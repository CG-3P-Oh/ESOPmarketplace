...
class DIPL_Modal extends ET_Builder_Module {
	...
	public function render( $attrs, $content, $render_slug ) {
		...
		wp_enqueue_script( 'dipl-modal-custom', ELICUS_DIVI_PLUS_PLUGIN_URL . 'includes/modules/Modal/dipl-modal-custom.min.js', array('jquery'), '1.0.4', true );
        ...
        wp_enqueue_style( 'dipl-modal-style', ELICUS_DIVI_PLUS_PLUGIN_URL . 'includes/modules/Modal/' . $file . '.min.css', array(), '1.0.0' );
