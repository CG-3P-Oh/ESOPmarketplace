...
class DIPL_ScrollImage extends ET_Builder_Module {
    ...
    public function render( $attrs, $content, $render_slug ) {
        ...
        wp_enqueue_script( 'dipl-scroll-image-custom', ELICUS_DIVI_PLUS_PLUGIN_URL . 'includes/modules/ScrollImage/dipl-scroll-image-custom.min.js', array('jquery'), '1.0.0', true );
        $file = et_is_builder_plugin_active() ? 'style-dbp' : 'style';
        wp_enqueue_style( 'dipl-scroll-image-style', ELICUS_DIVI_PLUS_PLUGIN_URL . 'includes/modules/ScrollImage/' . $file . '.min.css', array(), '1.0.0' );
