...
class DIPL_TwitterFollowButton extends ET_Builder_Module {
	...
	public function render( $attrs, $content, $render_slug ) {
		...
		if ( '' !== $twitter_username ) {
			//wp_enqueue_script( 'dipl-twitter-follow-button-custom', ELICUS_DIVI_PLUS_PLUGIN_URL . 'includes/modules/TwitterFollowButton/dipl-twitter-follow-button-custom.min.js', array('jquery'), '1.0.0', true );
			$file = et_is_builder_plugin_active() ? 'style-dbp' : 'style';
        	wp_enqueue_style( 'dipl-twitter-follow-button-style', ELICUS_DIVI_PLUS_PLUGIN_URL . 'includes/modules/TwitterFollowButton/' . $file . '.min.css', array(), '1.0.0' );
