...
class DIPL_Timeline extends ET_Builder_Module {
	...
	public function render( $attrs, $content, $render_slug ) {
		...
		wp_enqueue_script( 'dipl-timeline-custom', ELICUS_DIVI_PLUS_PLUGIN_URL . "includes/modules/Timeline/dipl-timeline-custom.min.js", array('jquery'), '1.0.0', true );
		$file = et_is_builder_plugin_active() ? 'style-dbp' : 'style';
        wp_enqueue_style( 'dipl-timeline-style', ELICUS_DIVI_PLUS_PLUGIN_URL . 'includes/modules/Timeline/' . $file . '.min.css', array(), '1.0.0' );
