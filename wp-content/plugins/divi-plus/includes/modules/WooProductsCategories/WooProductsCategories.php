...
class DIPL_WooProductsCategories extends ET_Builder_Module {
	...
	public function render( $attrs, $content, $render_slug ) {
		...
		wp_enqueue_script( 'dipl-woo-products-categories-custom', ELICUS_DIVI_PLUS_PLUGIN_URL . 'includes/modules/WooProductsCategories/dipl-woo-products-categories-custom.min.js', array('jquery'), '1.0.0', true );
		$file = et_is_builder_plugin_active() ? 'style-dbp' : 'style';
        wp_enqueue_style( 'dipl-woo-products-categories-style', ELICUS_DIVI_PLUS_PLUGIN_URL . 'includes/modules/WooProductsCategories/' . $file . '.min.css', array(), '1.0.0' );
