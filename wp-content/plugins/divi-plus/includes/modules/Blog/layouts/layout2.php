 ...
 *
 * This template can be overridden by copying it to yourtheme/divi-plus/layouts/blog/layout2.php
 *
	...
	$output    .= sprintf(
		...
		(
			...
			et_core_intentionally_unescaped(
				sprintf(
					'<span class="dipl_blog_post_author"><span class="dipl_blog_post_author_icon et-pb-icon">&#xe08a;</span><span class="dipl_blog_post_author_name">%1$s%2$s</span></span>',
					esc_html__( 'Posted By', 'divi-plus' ),
		...
		(
			...
			et_get_safe_localization(
				sprintf(
					'<span class="dipl_blog_post_published"><span class="dipl_blog_post_published_icon et-pb-icon">&#xe023;</span><span class="dipl_blog_post_published_date">%1$s<span>%2$s</span></span></span>',
					esc_html__( 'Posted On', 'divi-plus' ),
		...
		(
			...
			et_get_safe_localization(
				sprintf(
					'<span class="dipl_blog_post_comments"><span class="dipl_blog_post_comments_icon et-pb-icon">&#xe066;</span><span class="dipl_blog_post_comments_count">%1$s<span>%2$s</span></span></span>',
					esc_html__( 'Comments', 'divi-plus' ),
					sprintf(
						// translators: %s: comment.
						esc_html( _nx( '%s', '%s', get_comments_number( $post_id ), 'number of comments', 'divi-plus' ) ),
